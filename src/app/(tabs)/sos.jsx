      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", marginBottom: 12 }}>
            ...
            >
              Compatible with Satellite Services
            </Text>
          </View>
          <Text
            style={{
          ...
          >
            If you have compatible hardware and an active subscription, this app
            works with satellite services like One.nz satellite SMS and Starlink
            + WhatsApp. The app uses your device's existing connectivity —
            satellite support depends on your provider. Set each contact's
            preferred method in your Profile.
          </Text>
        </View>
